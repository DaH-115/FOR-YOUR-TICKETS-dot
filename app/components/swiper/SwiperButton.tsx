...
export default function SwiperButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`absolute top-1/2 z-50 hidden text-3xl text-white/80 opacity-0 transition-all duration-150 ease-out hover:scale-110 group-hover/swiper:opacity-100 xl:block ${
